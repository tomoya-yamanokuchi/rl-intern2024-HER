...
class RandomCtrlDataCollectionObjectDirector(AbstractDomainObjectDirector):
    @staticmethod
    def construct(builder: DomainObjectBuilder, env_name: str, dataset_name : str= None) -> DomainObject:
        ...
        builder.build_data_collection_planning()
        builder.build_icem_multiprocessing_random_data_collection()
