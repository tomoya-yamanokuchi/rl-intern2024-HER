...
class RobelDClawCubeDomainInfo(object):
    """
    mac reward -120.
    """
    ...
    def __init__(self, userDefinedSettings, domain_range=None):
        ...
        self.set_domain_parameter_all_space(
            ...
            randomization_flag = userDefinedSettings.DOMAIN_RANDOMIZATION_FLAG
        )
    ...
    def set_domain_parameter_all_space(self, domain_range=None, randomization_flag=True):
        if randomization_flag:
            ...
            sampling_method = 'fix'
        self.dt            = DomainParameter(name='dt', initial_value=0.05, min_value=0.045, max_value=0.055, sampling_method=sampling_method)
        ...
        self.torque_weight = DomainParameter(name='torque_weight', initial_value=1., min_value=0.8, max_value=1.5, sampling_method=sampling_method)
