...
class ViRCCEDomainObject:
    ...
    def set_content_prior(self, content_prior):
        from cdsvae.domain.model.generative_model.content_prior import AbstracContentPrior
        self.content_prior : AbstracContentPrior = content_prior
    ...
    # ---- decoder ----
    def set_latent_frame_decoder(self, latent_frame_decoder: nn.Module):
        from cdsvae.domain.model.generative_model.latent_frame_decoder import AbstractLatentFrameDecoder
        self.latent_frame_decoder : AbstractLatentFrameDecoder = latent_frame_decoder
